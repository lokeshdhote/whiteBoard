            ...
            <form onSubmit={formSubmit}className="w-fit h-fit border-2 border-black px-[4vw] py-[4vw]   "> 
                <div className="flex flex-col gap-[0.7vw]  ">
                    <div className="flex flex-col items-start gap-[0.5vw] " >
                        <label htmlFor="Name" className="pl-[0.3vw]">Name</label>
                        <input  onChange={(e)=>setName(e.target.value)} type="text" placeholder="Name" value={Name} className=" pl-[1vw] w-[15vw] h-[2.7vw]   outline-none border rounded  border-zinc-700"  />
                    </div>
                    <div className="flex flex-col items-start gap-[0.5vw] " >
